...
g(e.join("")).appendTo(c.county)}c.zipcode.val("")},bindings:function(){var b=this,a=b.options,c=b.wrap,d="",e="",l="";c.county.on("change.twzipcode",function(){var h=g(this).val(),d="",e=[];c.district.empty();if(h){if(!0===a.zipcodeIntoDistrict)for(d in f[h])"undefined"!==typeof f[h][d]&&(e.push('<option value="'+d+'">'),e.push(f[h][d]+" "+d),e.push("</option>"));else for(d in f[h])"undefined"!==typeof f[h][d]&&(e.push('<option value="'+d+'">'),e.push(d),e.push("</option>"));c.district.append(e.join("")).trigger("change.twzipcode")}else c.county.find("option:first").prop("selected",
...
typeof f[d][e]&&b===f[d][e]){c.county.val(d).trigger("change.twzipcode");c.district.val(e).trigger("change.twzipcode");break}"function"===typeof a.onZipcodeKeyUp&&a.onZipcodeKeyUp.call(this)});d="undefined"!==typeof a.zipcodeSel?a.zipcodeSel:"undefined"!==typeof b.role.zipcode.data("value")?b.role.zipcode.data("value"):a.zipcodeSel;e="undefined"!==typeof a.countySel?a.countySel:"undefined"!==typeof b.role.county.data("value")?b.role.county.data("value"):a.countySel;l="undefined"!==typeof a.districtSel?
a.districtSel:"undefined"!==typeof b.role.district.data("value")?b.role.district.data("value"):a.districtSel;e&&(b.wrap.county.val(e).trigger("change.twzipcode"),"undefined"!==typeof f[e][l]&&b.wrap.district.val(l).trigger("change.twzipcode"));d&&3===d.toString().length&&b.wrap.zipcode.val(d).trigger("blur.twzipcode")},geoLocation:function(){var b=this,a=navigator.geolocation,c={maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1},d=b.options;a&&a.getCurrentPosition(function(a){var c={};"coords"in a&&
"latitude"in a.coords&&"longitude"in a.coords&&(c=[a.coords.latitude,a.coords.longitude],g.getJSON("https://maps.googleapis.com/maps/api/geocode/json",{key:d.googleMapsKey,sensor:!1,latlng:c.join(",")},function(a){a&&"undefined"!==typeof a.results&&"undefined"!==typeof a.results[0].address_components&&"undefined"!==typeof a.results[0].address_components[0]&&(a=a.results[0].address_components[a.results[0].address_components.length-1].long_name)&&b.wrap.zipcode.val(a.toString()).trigger("blur.twzipcode")}))},
function(a){console.error(a)},c)},init:function(){var b=this.container,a=this.options,c={county:b.find("[data-role=county]:first"),district:b.find("[data-role=district]:first"),zipcode:b.find("[data-role=zipcode]:first")},d=c.county.data("name")||a.countyName,e=c.district.data("name")||a.districtName,f=c.zipcode.data("name")||a.zipcodeName,h=c.zipcode.data("placeholder")||a.zipcodePlaceholder,k=c.zipcode.data("readonly")||a.readonly;g("<select/>").attr("name",d).addClass("form-control").addClass(c.county.data("style")||
("undefined"!==typeof a.css[0]?a.css[0]:"")).appendTo(c.county.length?c.county:b);g("<select/>").attr("name",e).addClass("form-control").addClass(c.district.data("style")||("undefined"!==typeof a.css[1]?a.css[1]:"")).appendTo(c.district.length?c.district:b);g("<input/>").attr({type:"text",name:f,placeholder:h}).prop("readonly",k).addClass("form-control").addClass(c.zipcode.data("style")||("undefined"!==typeof a.css[2]?a.css[2]:"")).appendTo(c.zipcode.length?c.zipcode:b);this.wrap=
{county:b.find('select[name="'+d+'"]:first'),district:b.find('select[name="'+e+'"]:first'),zipcode:b.find('input[type=text][name="'+f+'"]:first')};!0===a.zipcodeIntoDistrict&&this.wrap.zipcode.hide();this.role=c;this.reset();this.bindings();!0===a.detect&&this.geoLocation()}};g.fn.twzipcode=function(b){var a={},c=[],d=arguments;return"string"===typeof b?(this.each(function(){a=g.data(this,"twzipcode");a instanceof k&&"function"===typeof a[b]&&(c=a[b].apply(a,Array.prototype.slice.call(d,1)))}),"undefined"!==
typeof c?c:this):this.each(function(){g.data(this,"twzipcode")||g.data(this,"twzipcode",new k(this,b))})}})(window.jQuery||{},window,document);